...
class Elite_Grid extends Group_Control_Query
{
    ...
    public function get_style_depends()
    {
        ...
        if ( $this->upk_is_edit_mode() ) {
            ...
            return [ 'ultimate-post-kit-font', 'upk-elite-grid' ];
        }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'title_divider_color', [
        ...
        $this->add_control( 'author_role_heading', [
        ...
        $this->add_responsive_control( 'author_role_spacing', [
            'label'     => esc_html__( 'Spacing', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
        ...
        $this->add_responsive_control( 'category_top_spacing', [
            'label'     => esc_html__( 'Spacing', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
        ...
        $this->add_control( 'category_date_heading', [
        ...
        $this->add_control( 'category_date_color', [
            'label'     => esc_html__( 'Color', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    public function render_post_grid_item( $post_id, $image_size, $excerpt_length )
    {
        ...
        if ( $settings['show_category'] == 'yes' or $settings['show_date'] == 'yes' ) {
            ?>
