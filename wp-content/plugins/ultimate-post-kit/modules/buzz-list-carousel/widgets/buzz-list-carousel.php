...
class Buzz_List_Carousel extends Group_Control_Query {
	...
	public function get_style_depends() {
		if ($this->upk_is_edit_mode()) {
			...
			return ['ultimate-post-kit-font', 'upk-buzz-list-carousel'];
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .upk-buzz-list-carousel .upk-meta .upk-separator' => 'margin: 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->register_navigation_style('buzz-list');
	}
