...
class Static_Social_Count extends Group_Control_Query {
	...
	public function get_style_depends() {
		if ($this->upk_is_edit_mode()) {
			...
			return ['ultimate-post-kit-font', 'upk-static-social-count'];
		}
	}
	...
	public function register_controls() {
		...
		$this->add_control(
			'select_style',
			[
				'label'      => esc_html__('Select Style', 'ultimate-post-kit-pro'),
				'type'       => Controls_Manager::SELECT,
				'default'    => '',
				'options'    => [
					''  => esc_html__('Style 1', 'ultimate-post-kit-pro'),
					'upk-style-2' => esc_html__('Style 2', 'ultimate-post-kit-pro'),
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'         => esc_html__('Column Gap', 'ultimate-post-kit-pro'),
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__('facebook', 'ultimate-post-kit-pro'),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$repeater->add_control(
			'social_site_link',
			[
				'label'             => esc_html__('Link', 'ultimate-post-kit-pro'),
				'type'              => Controls_Manager::URL,
				'placeholder'       => esc_html__('https://facebook.com', 'ultimate-post-kit-pro'),
				'show_external'     => true,
				'default'           => [
		...
		$repeater->add_control(
			'social_counter',
			[
				'label'     => esc_html__('Number', 'ultimate-post-kit-pro'),
				'type'      => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'social_counter_list',
			[
				'label'         => esc_html__('Social', 'ultimate-post-kit-pro'),
				'type'          => Controls_Manager::REPEATER,
				'fields'        => $repeater->get_controls(),
				'default'       => [
					[
						'social_site_name'    => esc_html__('Facebook', 'ultimate-post-kit-pro'),
						'social_site_icon' => [
							'value' => 'fab fa-facebook',
							'library' => 'fa-brands',
						],
						'social_counter'    => esc_html__('450', 'ultimate-post-kit-pro'),
						'social_site_meta'    => esc_html__('Likes', 'ultimate-post-kit-pro'),
						'social_site_link' => [
							'url' => esc_html__('https://facebook.com/bdthemes', 'ultimate-post-kit-pro')
						]
					],
					[
						'social_site_name'    => esc_html__('Twitter', 'ultimate-post-kit-pro'),
						'social_site_icon' => [
							'value' => 'fab fa-twitter',
							'library' => 'fa-brands',
						],
						'social_counter'    => esc_html__('3000', 'ultimate-post-kit-pro'),
						'social_site_meta'    => esc_html__('Followers', 'ultimate-post-kit-pro'),
						'social_site_link' => [
							'url' => esc_html__('https://twitter.com/bdthemescom', 'ultimate-post-kit-pro')
						]
					],
					[
						'social_site_name'    => esc_html__('Youtube', 'ultimate-post-kit-pro'),
						'social_site_icon' => [
							'value' => 'fab fa-youtube',
							'library' => 'fa-brands',
						],
						'social_counter'    => esc_html__('2000000', 'ultimate-post-kit-pro'),
						'social_site_meta'    => esc_html__('Subscriber', 'ultimate-post-kit-pro'),
						'social_site_link' => [
							'url' => esc_html__('https://youtube.com/bdthemes', 'ultimate-post-kit-pro')
						]
					],
					[
						'social_site_name'    => esc_html__('Instagram', 'ultimate-post-kit-pro'),
						'social_site_icon' => [
							'value' => 'fab fa-instagram',
							'library' => 'fa-brands',
						],
						'social_counter'    => esc_html__('105000', 'ultimate-post-kit-pro'),
						'social_site_meta'    => esc_html__('Followers', 'ultimate-post-kit-pro'),
						'social_site_link' => [
							'url' => esc_html__('https://instagram.com/bdthemes', 'ultimate-post-kit-pro')
						]
					],
				],
		...
		$this->add_responsive_control(
			...
			[
				'label'                 => esc_html__('Radius', 'ultimate-post-kit-pro'),
				'type'                  => Controls_Manager::DIMENSIONS,
				'size_units'            => ['px', '%', 'em'],
				'selectors'             => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Icons', 'ultimate-post-kit-pro'),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->start_controls_tabs(
		...
		$this->start_controls_section(
			'social_counter',
			[
				'label' => esc_html__('Counter', 'ultimate-post-kit-pro'),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
