...
class Featured_List extends Group_Control_Query {
	...
	public function get_style_depends() {
		if ($this->upk_is_edit_mode()) {
			...
			return ['ultimate-post-kit-font', 'upk-featured-list'];
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .upk-featured-list .upk-item .upk-image-wrap .upk-img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .upk-featured-list .upk-item:nth-child(1) .upk-content, {{WRAPPER}} .upk-featured-list .upk-item:nth-last-child(1) .upk-content' => 'padding-bottom: calc(2 * {{TOP}}{{UNIT}});',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .upk-featured-list .upk-item:nth-child(1) .upk-image-wrap',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .upk-featured-list .upk-item:nth-child(1) .upk-image-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .upk-featured-list .upk-item .upk-featured-meta .upk-separator' => 'margin: 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
...
?>
	...
	protected function render() {
		...
		$this->add_render_attribute('list-wrap', 'class', 'upk-featured-list');
