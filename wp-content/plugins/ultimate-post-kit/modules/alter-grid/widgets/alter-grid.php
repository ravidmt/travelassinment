...
class Alter_Grid extends Group_Control_Query
{
    ...
    public function get_style_depends()
    {
        ...
        if ( $this->upk_is_edit_mode() ) {
            ...
            return [ 'ultimate-post-kit-font', 'upk-alter-grid' ];
        }
    ...
    public function render_readmore()
    {
        ...
        ?>" class="upk-readmore upk-display-inline-block <?php 
        ...
        if ( $settings['readmore_icon']['value'] ) {
            ?>
				<span class="upk-button-icon-align-<?php 
    ...
    public function render_post_grid_item( $post_id, $image_size, $excerpt_length )
    {
        ...
        if ( $settings['show_author'] or $settings['show_date'] or $settings['show_reading_time'] ) {
            ...
            if ( $settings['show_author'] ) {
                ?>
									<div class="upk-blog-author" data-separator="<?php 
