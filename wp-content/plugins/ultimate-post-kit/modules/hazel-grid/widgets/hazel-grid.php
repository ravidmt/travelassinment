...
class Hazel_Grid extends Group_Control_Query
{
    ...
    public function get_style_depends()
    {
        ...
        if ( $this->upk_is_edit_mode() ) {
            ...
            return [ 'ultimate-post-kit-font', 'upk-hazel-grid' ];
        }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'item_limit_3_4_5_6', [
            'label'     => esc_html__( 'Item Limit', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
        ...
        $this->add_responsive_control( 'title_text_margin', [
        ...
        $this->end_controls_section();
        $this->start_controls_section( 'section_style_author_date', [
        ...
        $this->add_control( 'date_divider_color', [
    ...
    public function render_image( $image_id, $size )
    {
		...
		<img class="upk-blog-image" src="<?php 
    ...
    public function render_title()
    {
        ...
        printf(
            '<%1$s class="upk-title"><a href="%2$s" title="%3$s" class="upk-blog-title">%3$s</a></%1$s>',
    ...
    public function render_category()
    {
		...
		<div class="upk-blog-badge">
			<span>
				<?php 
        echo  upk_get_category( $this->get_settings( 'posts_source' ) ) ;
        ?>
			</span>
		</div>
	<?php 
