	...
	class Author extends Module_Base {
		...
		public function get_style_depends() {
			if ( $this->upk_is_edit_mode() ) {
				...
				return [ 'ultimate-post-kit-font', 'upk-author' ];
			}
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'options'   => [
						'25'  => __( '25 x 25', 'ultimate-post-kit' ),
						'35'  => __( '35 x 35', 'ultimate-post-kit' ),
						'45'  => __( '45 x 45', 'ultimate-post-kit' ),
						'60'  => __( '60 x 60', 'ultimate-post-kit' ),
						'80'  => __( '80 x 80', 'ultimate-post-kit' ),
						'100' => __( '100 x 100', 'ultimate-post-kit' ),
						'150' => __( '150 x 150', 'ultimate-post-kit' ),
						'200' => __( '200 x 200', 'ultimate-post-kit' ),
						'250' => __( '250 x 250', 'ultimate-post-kit' ),
					],
					'default'   => '250',
				]
			);
