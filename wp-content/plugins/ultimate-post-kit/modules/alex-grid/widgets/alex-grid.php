...
class Alex_Grid extends Group_Control_Query
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control( 'default_item_height', [
        ...
        $this->add_responsive_control( 'primary_item_height', [
        ...
        $this->add_responsive_control( 'secondary_item_height', [
        ...
        $this->add_control( 'show_post_format', [
        ...
        $this->end_controls_section();
        //Style
        $this->start_controls_section( 'upk_section_style', [
        ...
        $this->add_control( 'overlay_blur_effect', [
        ...
        $this->add_control( 'overlay_blur_level', [
        ...
        $this->add_responsive_control( 'secondary_content_width', [
        ...
        $this->add_responsive_control( 'secondary_content_height', [
        ...
        $this->add_responsive_control( 'content_secondary_inner_padding', [
        ...
        $this->add_control( 'title_border_hover_color', [
        ...
        $this->end_controls_tabs();
        $this->end_controls_section();
        $this->start_controls_section( 'section_style_readmore', [
        ...
        $this->start_controls_tab( 'tab_readmore_normal', [
        ...
        $this->add_responsive_control( 'readmore_radius', [
            'label'      => __( 'Border Radius', 'ultimate-post-kit' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', '%' ],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'readmore_primary_padding', [
            'label'      => __( 'Padding', 'ultimate-post-kit' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'readmore_secondary_padding', [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'tab_readmore_hover', [
            'label' => __( 'Hover', 'ultimate-post-kit' ),
        ] );
        $this->add_control( 'readmore_hover_text_color', [
            'label'     => __( 'Color', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'author_image_heading', [
        ...
        $this->add_responsive_control( 'author_image_spacing', [
            'label'     => esc_html__( 'Spacing', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
        ...
        $this->add_control( 'author_name_color', [
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
            '{{WRAPPER}} .upk-alex-grid .upk-meta .upk-author-name a, {{WRAPPER}} .upk-alex-grid .upk-meta .upk-date, {{WRAPPER}} .upk-alex-grid .upk-meta .upk-post-time' => 'color: {{VALUE}};',
        ],
        ] );
        $this->add_control( 'author_name_hover_color', [
        ...
        $this->add_group_control( Group_Control_Typography::get_type(), [
            ...
            'label'    => esc_html__( 'Typography', 'ultimate-post-kit' ),
            'selector' => '{{WRAPPER}} .upk-alex-grid .upk-meta .upk-author-name a, {{WRAPPER}} .upk-alex-grid .upk-meta .upk-date, {{WRAPPER}} .upk-alex-grid .upk-meta .upk-post-time',
        ] );
        $this->end_controls_section();
        $this->start_controls_section( 'section_style_post_format', [
            'label'     => esc_html__( 'Post Format', 'ultimate-post-kit' ) . BDTUPK_NC,
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [
        ...
        $this->add_control( 'post_format_color', [
            'label'     => esc_html__( 'Color', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'overlay_blur_effect_post_format', [
            'label'       => esc_html__( 'Glassmorphism', 'ultimate-post-kit' ),
            'type'        => Controls_Manager::SWITCHER,
            'description' => sprintf( __( 'This feature will not work in the Firefox browser untill you enable browser compatibility so please %1s look here %2s', 'ultimate-post-kit' ), '<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/backdrop-filter#Browser_compatibility" target="_blank">', '</a>' ),
            'default'     => 'yes',
        ...
        $this->add_control( 'overlay_blur_level_post_format', [
            'label'     => __( 'Blur Level', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
        ...
        $this->add_responsive_control( 'post_format_border_radius', [
            'label'      => esc_html__( 'Border Radius', 'ultimate-post-kit' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', '%' ],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'post_format_padding', [
            'label'      => __( 'Padding', 'ultimate-post-kit' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'post_format_margin', [
        ...
        $this->add_responsive_control( 'post_format_size', [
            'label'     => esc_html__( 'Size', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
    ...
    public function render_author_date()
    {
        ...
        if ( $settings['show_author'] or $settings['show_date'] or $settings['show_time'] ) {
            ?>
			<div class="upk-meta">
				<?php 
    ...
    protected function render()
    {
        ...
        if ( $settings['show_pagination'] ) {
			...
			<div class="ep-pagination">
				<?php 
            ultimate_post_kit_post_pagination( $wp_query, $this->get_id() );
            ?>
			</div>
		<?php 
        }
