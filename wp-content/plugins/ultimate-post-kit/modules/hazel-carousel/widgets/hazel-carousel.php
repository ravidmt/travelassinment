...
class Hazel_Carousel extends Group_Control_Query {
	...
	public function get_style_depends() {
		if ($this->upk_is_edit_mode()) {
			...
			return ['ultimate-post-kit-font', 'upk-hazel-carousel'];
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .upk-hazel-carousel .upk-blog-content-style-3 .upk-blog-box-content .upk-blog-post-meta',
				'condition' => [
					'content_style' => '3',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .upk-hazel-carousel .upk-post-grid-item .upk-post-grid-item-box .upk-blog-box-content .upk-blog-post-meta *' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .upk-hazel-carousel .upk-post-grid-item .upk-post-grid-item-box .upk-blog-box-content .upk-blog-post-meta .upk-blog-author a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .upk-hazel-carousel .upk-post-grid-item .upk-post-grid-item-box .upk-blog-box-content .upk-blog-post-meta .upk-blog-date::before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Typography', 'ultimate-post-kit'),
				'selector' => '{{WRAPPER}} .upk-hazel-carousel .upk-post-grid-item .upk-post-grid-item-box .upk-blog-box-content .upk-blog-post-meta',
			]
		);
