...
class Maple_Grid extends Group_Control_Query
{
    ...
    public function get_style_depends()
    {
        ...
        if ( $this->upk_is_edit_mode() ) {
            ...
            return [ 'ultimate-post-kit-font', 'upk-maple-grid' ];
        }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'show_author_avatar', [
        ...
        $this->add_control( 'show_author_name', [
        ...
        $this->add_control( 'item_image_heading', [
            'label'     => esc_html__( 'Image', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ] );
        $this->add_responsive_control( 'item_image_border_radius', [
            'label'      => esc_html__( 'Border Radius', 'ultimate-post-kit' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', '%' ],
            'selectors'  => [
        ...
        $this->start_controls_tab( 'tab_post_format_normal', [
            'label' => esc_html__( 'Normal', 'ultimate-post-kit' ),
        ] );
        ...
        $this->add_responsive_control( 'post_format_spacing', [
            'label'     => esc_html__( 'Spacing', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'tab_post_format_hover', [
            'label' => esc_html__( 'Hover', 'ultimate-post-kit' ),
        ] );
        $this->add_control( 'post_format_hover_color', [
            'label'     => esc_html__( 'Color', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'post_format_hover_border_color', [
            'label'     => esc_html__( 'Border Color', 'ultimate-post-kit' ),
            'type'      => Controls_Manager::COLOR,
            'condition' => [
    ...
    public function render_author()
    {
        ...
        if ( $settings['show_author_avatar'] == 'yes' or $settings['show_author_name'] == 'yes' ) {
            ?>
			<div class="upk-author">
				<?php 
            
            if ( $settings['show_author_avatar'] == 'yes' ) {
                ?>
					<?php 
        ...
        if ( $settings['show_date'] == 'yes' ) {
            ?>
								<div class="upk-blog-date">
									<a class="date" href="#">
										<i class="upk-icon-calendar" aria-hidden="true"></i><?php 
            $this->render_date();
            ?>
									</a>
								</div>
