...
class Social_Share extends Module_Base
{
    ...
    public function get_style_depends()
    {
        ...
        if ( $this->upk_is_edit_mode() ) {
            ...
            return [ 'ultimate-post-kit-font', 'upk-social-share' ];
        }
    ...
    public function render()
    {
        ...
        foreach ( $settings['share_buttons'] as $button ) {
            ...
            $this->add_render_attribute(
                [
                'social-attrs' => [
                'class'       => [ 'upk-ss-btn', 'upk-ss-' . $social_name ],
            ...
            ?>
				<div class="upk-social-share-item upk-ep-grid-item">
					<div <?php 
            $this->print_render_attribute_string( 'social-attrs' );
            ?>>
						<?php 
            ...
            if ( $show_text || $has_counter ) {
                ...
                if ( $has_counter ) {
                    ?>
									<span class="upk-social-share-counter" data-counter="<?php 
