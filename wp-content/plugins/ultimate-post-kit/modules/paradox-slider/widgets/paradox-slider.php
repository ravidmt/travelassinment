...
class Paradox_Slider extends Group_Control_Query {
	...
	public function get_style_depends() {
		if ($this->upk_is_edit_mode()) {
			...
			return ['ultimate-post-kit-font', 'upk-paradox-slider'];
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .upk-paradox-slider .upk-paradox-slider-item .upk-paradox-date, {{WRAPPER}} .upk-paradox-slider .upk-paradox-slider-item .upk-post-time' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .upk-paradox-slider .upk-paradox-slider-item .upk-paradox-date' => 'padding-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Typography', 'ultimate-post-kit'),
				'selector' => '{{WRAPPER}} .upk-paradox-slider .upk-paradox-slider-item .upk-paradox-date, {{WRAPPER}} .upk-paradox-slider .upk-paradox-slider-item .upk-post-time',
			]
		);
