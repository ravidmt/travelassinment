...
class Alice_Carousel extends Group_Control_Query {
	...
	public function get_style_depends() {
		if ($this->upk_is_edit_mode()) {
			...
			return ['ultimate-post-kit-font', 'upk-alice-carousel'];
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .upk-alice-carousel .upk-meta .upk-author *, {{WRAPPER}} .upk-alice-carousel .upk-meta .upk-date, {{WRAPPER}} .upk-alice-carousel .upk-meta .upk-post-time' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Typography', 'ultimate-post-kit'),
				'selector' => '{{WRAPPER}} .upk-alice-carousel .upk-meta .upk-author, {{WRAPPER}} .upk-alice-carousel .upk-meta .upk-date, {{WRAPPER}} .upk-alice-carousel .upk-meta .upk-post-time',
			]
		);
		...
		$this->register_navigation_style('alice');
	}
