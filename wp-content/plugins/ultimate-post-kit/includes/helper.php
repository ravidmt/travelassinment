 ...
 * @return array string
 */
function ultimate_post_kit_get_post_types( $args = array() )
{
    $post_type_args = [
    ...
    $post_types = [
        '0' => esc_html__( 'Select Type', 'ultimate-post-kit' ),
    ];
...
function ultimate_post_kit_get_menu()
{
    ...
    $items = [
        0 => esc_html__( 'Select Menu', 'ultimate-post-kit' ),
    ];
...
function ultimate_post_kit_et_options()
{
    ...
    if ( empty($templates) ) {
        $template_options = [
            '0' => __( 'Template Not Found!', 'ultimate-post-kit' ),
        ];
    } else {
        $template_options = [
            '0' => __( 'Select Template', 'ultimate-post-kit' ),
        ];
...
function ultimate_post_kit_mask_shapes()
{
    ...
    $extension = '.svg';
    $list = [
        0 => esc_html__( 'Select Mask', 'ultimate-post-kit' ),
    ];
    for ( $i = 1 ;  $i <= 20 ;  $i++ ) {
...
function ultimate_post_kit_dashboard_link( $suffix = '#welcome' )
{
    return add_query_arg( [
        'page' => 'ultimate_post_kit_options' . $suffix,
    ], admin_url( 'admin.php' ) );
}
