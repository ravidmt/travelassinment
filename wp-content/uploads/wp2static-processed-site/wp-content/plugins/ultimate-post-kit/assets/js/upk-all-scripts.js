            ...
            scope.find('.upk-forbes-tabs').each(function () {
                ...
                if (element) {
                    ...
                    tabs.on('click', function (e) {
                        ...
                        //     category: category,
                        //     show_category: $settings_showHide['show_category'],
                        //     show_title: $settings_showHide['show_title'],
                        //     show_meta: $settings_showHide['show_meta'],
                        //     show_author: $settings_showHide['show_author']
...
(function($, elementor) {
    ...
    var widgetIconicSlider = function($scope, $) {

        var $carousel = $scope.find('.upk-iconic-slider');
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/upk-iconic-slider.default', widgetIconicSlider);
    });
